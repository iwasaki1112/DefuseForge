...
APK_OUTPUT="$PROJECT_ROOT/godot/builds/android/godot.apk"
...
# ビルドディレクトリを作成
mkdir -p "$PROJECT_ROOT/godot/builds/android"

# APKをエクスポート
echo "1. APKをエクスポート中..."
"$GODOT_PATH" --headless --path "$PROJECT_ROOT/godot" --export-debug "Android" "builds/android/godot.apk"
